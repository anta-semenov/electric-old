...
import { DatabaseAdapter } from '@anta-semenov/electric-sql-drivers/expo-sqlite-next'
import { ElectricConfig } from '../../config'
import type { Database } from '@anta-semenov/electric-sql-drivers/expo-sqlite-next'
