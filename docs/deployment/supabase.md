...
Run your [Electric sync service](../api/service), either locally or [via one of the other deployment options](../top-level-listings/deployment.md), with the following [configuration options](../api/service.md):
